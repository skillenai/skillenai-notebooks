...
- **Two more walls the pension analysis didn't cover:** **70% of federal tech postings require a real security clearance** (85% in security roles) vs low single digits private; and **fully-remote federal tech is ~0.3%** of postings — effectively closed — vs ~31% private.
...
**Remote.** The federal announcement text lets us measure something our own index mis-labels: actual remote status. **Fully-remote federal tech postings are 0.3%** — effectively zero — even though 63% are "telework-eligible" (situational/ad-hoc telework tied to a duty station, not location freedom). Private tech is ~31% fully-remote and ~44% any-remote. The location-independent job that a third of private tech now offers barely exists in federal hiring.
