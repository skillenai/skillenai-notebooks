...
`authors.json` snapshots in this folder. Rankings apply standard junk-author
filtering and the [Private Blog Network domain denylist](../synthetic-breakout-may-2026/network_domains_seed.csv)
